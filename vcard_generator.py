...
# Add field CLASS with value "vcard_generator" to each card for easy
# distinguishing between real and fake cards in case of a mix up with real cards.
add_class_field = True
